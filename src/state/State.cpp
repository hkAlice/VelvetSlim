    ...
    for( const auto& model : m_models )
    {
        ...
        { 
            ...
            {   
                ...
                //m_vRenderer.drawLine( { x0, y0 }, { x1, y1 }, pTest3 );
            }
            ...
            if( intensity > 0.f ) 
            {
                ...
                pTest3.r = intensity * 255;
                pTest3.g = intensity * 255;
                pTest3.b = intensity * 255;

                m_vRenderer.drawTriangle( trianglePos[0], trianglePos[1], trianglePos[2], pTest3 );
            } 
        }
    }
